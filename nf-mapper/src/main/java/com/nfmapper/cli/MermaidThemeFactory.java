...
final class MermaidThemeFactory {
    MermaidTheme create(String name) {
        ...
        return switch (normalized) {
            case "nf-core", "nfcore", "base" -> new NfCoreMermaidTheme();
            case "plain", "mermaid-default", "default" -> new PlainMermaidTheme();
            default -> throw new IllegalArgumentException(
                    "Invalid --theme value '" + name + "'. Allowed: nf-core, plain, default");
        };
    }
}
