...
class MermaidRendererTest {
        ...
        void testStartsWithInitThenGitGraph() {
                ...
                assertEquals("%% Generated by nf-mapper: https://github.com/Skitionek/nf-mapper", lines[0]);
                // Init line: starts with %%{init: ...
                assertTrue(lines[1].startsWith("%%{init: "), "Expected init line, got: " + lines[1]);
                // nf-core theme
                assertTrue(lines[1].contains("'theme': 'base'"), "Expected theme:base in init");
                assertTrue(lines[1].contains("'git0': '#24B064'"), "Expected nf-core green in themeVariables");
                // gitGraph section
                assertTrue(lines[1].contains("'showBranches': true"), "Expected showBranches:true in init");
                assertTrue(lines[1].contains("'parallelCommits': false"), "Expected parallelCommits:false in init");
                assertEquals("gitGraph LR:", lines[2]);
                assertEquals("   checkout main", lines[3]);
        }
        ...
        void testTitleAddsFrontMatter() {
                ...
                assertEquals("%% Generated by nf-mapper: https://github.com/Skitionek/nf-mapper", lines[3]);
                assertTrue(lines[4].startsWith("%%{init:"), "Expected init on line 4");
                assertEquals("gitGraph LR:", lines[5]);
                assertEquals("   checkout main", lines[6]);
        }
