...
> Generated from `nf-mapper/src/test/resources/fixtures/quantms_style/main.nf`

```mermaid
---
title: quantms-style pipeline
---
...
gitGraph LR:
   checkout main
   commit id: "INPUT_CHECK"
   commit id: "CREATE_INPUT_CHANNEL"
   commit id: "FILE_PREPARATION"
   commit id: "SUMMARY_PIPELINE"
   commit id: "PIPELINE_COMPLETION"
```
